...
|----------|------------|---------|
| System Hardening | `system_hardening` | SIP, Gatekeeper, FileVault, macOS Firewall |
...
| Supply Chain | `supply_chain` | VS Code extensions, npm globals, brew taps, MCP servers, pip |
